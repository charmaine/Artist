...
export class AppComponent {
  ...
  // name = "Charmaine";
  // artists = ["Taylor Swift", "Hilary Duff"];
  // name: string;
  // artists: any;
  //
...
// }
  ...
  //   this.name = myName;
  //   myElement.style.backgroundColor= "#E6E6FA";

    //console.log(e.target.innerHTML);
    //print what the event is in console; navigate into where your desired field is aka /target/innerHTML
  // }
  //
  // addArtist(myArtist){
  ...
  // name = "Charmaine";
  // becomes property of component
  // but above is better way of doing this in TS
}
